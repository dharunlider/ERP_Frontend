  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/Incentive/excel/export-incentives?fromDate=${fromDate}&toDate=${toDate}`,
        {
          method: "GET",
        }
      );
      ...
      link.href = url;
      link.setAttribute("download", "incentives.xlsx");
      document.body.appendChild(link);
      link.click();
      link.remove();
      toast.success("Incentives exported successfully!");
    } catch (error) {
