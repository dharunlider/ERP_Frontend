...
import { Box, Tab, Tabs, TextField, TableContainer, Table, TableBody, TableCell, TableHead, TableRow, Chip, InputAdornment, Typography } from '@mui/material';
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      >
        ...
        {role === "TEAMLEAD" && (<Tab label="Emergency Leave " sx={{ display: isStaff ? 'flex' : 'none' }} />)}
                  ...
                  <TableRow hover key={index}>
                    ...
                    <TableCell align="center">
                      ...
                      >
                        ...
                        {['annualLeave', 'sickLeave', 'paternityLeave'].includes(row.relatedReason) && (
      ...
      {isStaff && (
        <>
          ...
          <TabPanel value={value} index={3}>
            {/* <Approverequest data={EmergencyRequestData} loading={loading.approveRequests} refreshData={fetchunApprove} /> */}
            <EmergencyLeave />
          </TabPanel>
        </>
      )}
