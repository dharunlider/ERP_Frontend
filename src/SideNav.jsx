...
import {
  AppBar, Toolbar, IconButton, Typography, Box, Drawer, List, ListItem, ListItemIcon,
  ListItemText, Collapse, Menu, MenuItem, Badge, useMediaQuery, useTheme,
} from "@mui/material";
import {
  Menu as MenuIcon,
...
import CustomerOrderHistory from './Product/CustomerOrderHistory.jsx';
import Procurement from './Procurements/Procurement.jsx';
import Expensive from './Expense/Expense.jsx';
...
const Layout = ({ children }) => {
  ...
  const handleAdminProfileMenuClick = () => {
  ...
  return (
    <Box sx={{ display: "flex", bgcolor: "#F0F4F8", minHeight: "100vh" }}>
        ...
        <Toolbar>
          ...
          >
            ...
            {role && role.toLowerCase() === "admin" && (
              <MenuItem onClick={handleAdminProfileMenuClick}>
      ...
      {/* Profile Modal */}
      <Profile open={profileModalOpen} onClose={handleProfileModalClose} />

      {/* Admin Profile Modal */}
      <AdminProfileForm open={adminProfileModalOpen} onClose={handleAdminProfileModalClose} />
